                ...
                <GridChain>
                        ...
                        <GridGame id="grid-container">
                            ...
                            <GridDragItem id="item2" startX={positions.item2.x} startY={positions.item2.y} onPositionChange={handlePositionChange}>
                                <p className=" text-gray-800 text-3xl mb-4">lorem ipsum</p>
                                <p className=" text-gray-800 text-5xl font-[cabinSketch] font-bold mb-2 tracking-widest">lorem</p>
                                <p className=" text-gray-800 text-5xl font-[cabinSketch] font-bold mb-2 tracking-widest">ipsum</p>
                            </GridDragItem> 
